...
function EditExam() {
    ...
    useEffect(() => {
        ...
        fetch('http://localhost:8080/classroom/get-classrooms', options)
            .then((res) => res.json())
            .then((res) => {
                setListClassrom(res);
            });
    ...
    const handleSubmit = () => {
        ...
        fetch('http://localhost:8080/question/create-update-image', {
            method: 'POST',
            body: formData,
        });
        ...
        fetch(`http://localhost:8080/exam/create-update`, options)
            .then((res) => res.json())
            .then((res) => {
                ...
                fetch(`http://localhost:8080/question/create-update-list`, options)
                    .then((res) => res.json())
                    .then((res) => {
                        ...
                        fetch(`http://localhost:8080/option/create-update-list`, options).then(() => {
                    ...
                    <div key={index} className={styles.questionItem}>
                        ...
                        <div className={styles.contentQuestion}>
                            ...
                            <div ref={(e) => (listRef[index] = e)}>
                                <img
                                    width={500}
                                    src={'http://localhost:8080/question/getimage/' + listQuestion[index].image}
                                    alt="image"
                                />
                            </div>
                        </div>
