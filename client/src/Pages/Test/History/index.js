...
function History() {
    ...
    useEffect(() => {
        fetch('http://localhost:8080/implementation/get-by-id/' + localStorage.getItem('implementation_id'), {
            method: 'GET',
            headers: {
                        ...
                        <div key={index} className={styles.question}>
                            <div className={styles.bodyQuestion}>
                                ...
                                {item.question.image && (
                                    <img
                                        width={500}
                                        src={'http://localhost:8080/question/getimage/' + item.question.image}
                                        alt=""
                                    />
                                )}
