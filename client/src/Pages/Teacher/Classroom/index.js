...
function Classroom() {
    ...
    const handleSubmit = (e, id) => {
        ...
        fetch('http://localhost:8080/classroom/create', options).then((res) => {
            render();
            setClassroom((prev) => ({
                ...prev,
                id: '',
    ...
    const handleSearch = (e) => {
        if (e.keyCode === 13) {
            ...
            fetch(`http://localhost:8080/classroom/get-classrooms?name=${e.target.value}`, options)
                .then((res) => res.json())
                .then((res) => {
                    setListClassrom(res);
                });
    ...
    const handleDelete = (e, id) => {
        ...
        fetch(`http://localhost:8080/classroom/delete/${id}`, options).then(() => {
            setOptionKey(null);
            render();
            notify(2);
        });
